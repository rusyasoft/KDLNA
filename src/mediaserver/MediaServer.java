...
public class MediaServer {
	...
	public MediaServer(InetAddress localAddress) throws ValidationException {
		...
		DeviceDetails details = new DeviceDetails("KDLNA1_LEFT", /// android.os.Build.MODEL, ///
		...
		//rustamchange//original//localDevice = new LocalDevice(new DeviceIdentity(udn), type, details, service);
		//assigning static identity 13131314-b0de-10e9-0000-0000171cd062
		localDevice = new LocalDevice(new DeviceIdentity(new UDN("13131314-b0de-10e9-0000-0000171cd062")), type, details, service);
		//////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//start http server
		/*rustamchange/// run without http server
		try {
			new HttpServer(port);
		}
