...
public class StaticTestRemoteDevice extends RemoteDevice {
	...
	public static RemoteDeviceIdentity remoteDeviceIdentity = new RemoteDeviceIdentity(
			new UDN("13131313-b0de-10e9-0000-0000171cd062"),
            maxAgeSeconds,
            URIUtil.createAbsoluteURL( MakeURL(), URI.create("/dev/13131313-b0de-10e9-0000-0000171cd062/desc.xml")),
            null,
            getLocalBaseAddress()
    );
	...
	public StaticTestRemoteDevice() throws ValidationException
	{
		super(
				...
				new RemoteService(
						...
						URI.create("/dev/13131313-b0de-10e9-0000-0000171cd062/svc/upnp-org/ContentDirectory/desc.xml"),
						URI.create("/dev/13131313-b0de-10e9-0000-0000171cd062/svc/upnp-org/ContentDirectory/action"),
						URI.create("/dev/13131313-b0de-10e9-0000-0000171cd062/svc/upnp-org/ContentDirectory/event"),
						new Action[] { 
